...
CREATE TABLE `Inviter` (
  `ac_num` int NOT NULL DEFAULT '0',
  `pra_num` int NOT NULL DEFAULT '0',
...
CREATE TABLE `Offrir` (
  ...
  `rap_num` int NOT NULL DEFAULT '0',
  `med_depotlegal` varchar(20) NOT NULL DEFAULT '',
  `off_quantite` int NOT NULL DEFAULT '1',
...
-- Dump completed on 2022-11-15 11:13:18
